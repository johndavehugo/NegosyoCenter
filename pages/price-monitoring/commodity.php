...
<head>
    ...
    <!-- =========================================================
         FONT AWESOME
         Use local AdminLTE Font Awesome only.
         This avoids the integrity error.
    ========================================================== -->
    <link
        rel="stylesheet"
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark navbar-dark">
        ...
        <div
            class="collapse navbar-collapse justify-content-end text-sm"
        ...
        >
            ...
            <ul class="navbar-nav navbar-sidebar justify-content-end">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a
                        class="nav-link text-sm pt-0 pb-0"
                    ...
                    >
                        ...
                        <div class="user-panel d-flex">
                            ...
                            <div class="info">
                                ...
                                <a
                                    href="#"
                                    class="d-block text-white text-sm"
                                >
                                    BEN GANAGANAG
                                </a>
                        ...
                        >
                            ...
                            <i
                                ...
                                style="
                                    background-color: rgb(16 16 16 / 42%);
                                    border-radius: 22px;
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            class="form-control"
                            placeholder="Example: kg, pcs, liter"
                            autocomplete="off"
                        >
