...
<head>
    ...
    <title>San Carlos City | Agencies</title>
            ...
            <div class="container-fluid">
                ...
                <div class="card card-raised mb-3">
                    <div class="card-body d-flex align-items-center justify-content-between px-4 py-3">
                        ...
                        <button type="button" class="btn btn-raised-primary btn-sm ml-auto"
                                id="btn_add_agency"
                                data-toggle="modal" data-target="#addAgencyModal">
                ...
                <div class="card card-raised no-hover">
                    <div class="card-body px-3 pt-3 pb-0">
                        <table id="tblAgency" class="table table-striped table-bordered mb-0"
                               style="width:100%;">
                            <thead>
                                <tr>
                                    <th>ID</th>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" id="agency_code" name="agency_code"
                           ...
                           placeholder="e.g. DTI" autocomplete="off" maxlength="20">
                </div>
                <div class="form-group">
                    <label class="msme-label">Agency Name <span class="text-danger">*</span></label>
                    <input type="text" id="agency_name" name="agency_name"
                           class="form-control msme-input"
                           placeholder="e.g. Department of Trade and Industry" autocomplete="off" maxlength="150">
                </div>
                <div class="form-group mb-0">
                    <label class="msme-label">Coverage</label>
                    <input type="text" id="agency_coverage" name="agency_coverage"
                           class="form-control msme-input"
                           placeholder="e.g. Basic Necessities and Prime Commodities (BNPC)" autocomplete="off" maxlength="255">
                </div>
            </div>
        ...
        <div class="modal-content msme-modal-content">
            ...
            <form id="updateAgencyForm">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="msme-label">Agency Code <span class="text-danger">*</span></label>
                        <input type="text" id="updateAgencyCode"
                               class="form-control msme-input"
                               placeholder="e.g. DTI" autocomplete="off" maxlength="20">
                    </div>
                    <div class="form-group">
                        <label class="msme-label">Agency Name <span class="text-danger">*</span></label>
                        <input type="text" id="updateAgencyName"
                               class="form-control msme-input"
                               placeholder="e.g. Department of Trade and Industry" autocomplete="off" maxlength="150">
                    </div>
                    <div class="form-group mb-0">
                        <label class="msme-label">Coverage</label>
                        <input type="text" id="updateAgencyCoverage"
                               class="form-control msme-input"
                               placeholder="e.g. Basic Necessities and Prime Commodities (BNPC)" autocomplete="off" maxlength="255">
                    </div>
                </div>
...
<script src="../../scripts/price-monitoring/agency-table.js"></script>
<script src="../../scripts/price-monitoring/agency-update.js"></script>
