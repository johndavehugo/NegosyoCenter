                    ...
                    <div class="card card-raised mb-3">
                        <div class="card-body d-flex align-items-center justify-content-between px-4 py-3">
                            <div>
                                <h5 class="mb-0 font-weight-bold">
                                    <i class="material-icons align-middle mr-1"
                                       style="font-size:22px;color:#007bff;vertical-align:middle;">cloud</i>
                                    Calamity Monitoring
                                </h5>
                            ...
                            <div class="ml-auto d-flex" style="gap:8px;">
                                <button type="button" class="btn btn-raised-primary btn-sm" id="btn_add_calamity" data-toggle="modal" data-target="#addCalamityModal">
                                    <i class="material-icons icon-sm leading-icon">add</i>Add Calamity
                                </button>
                                <button type="button" class="btn btn-raised-secondary btn-sm" id="btn_add_incident" data-toggle="modal" data-target="#addIncidentModal">
                                    <i class="material-icons icon-sm leading-icon">add</i>Add Incident
                                </button>
                            </div>
                        </div>
                    </div>
