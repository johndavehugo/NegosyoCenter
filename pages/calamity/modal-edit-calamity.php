        ...
        <div class="modal-content msme-modal-content">
            ...
            <div class="modal-header msme-modal-header">
                <h5 class="modal-title d-flex align-items-center">
                    <i class="material-icons text-primary mr-2" style="font-size:22px;">edit</i>Edit Calamity
                </h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-0">
                            ...
                            <textarea class="form-control msme-input" id="editCalamityDescription" name="editCalamityDescription" rows="1"></textarea>
                        </div>
                    </div>
                </div>
            </div>
