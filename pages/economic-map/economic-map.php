...
<head>
    ...
    <style>
        ...
        .stat-pill .label { font-size: 1.05rem; font-weight: 700; text-transform: none;
                            letter-spacing: 0; color: #1a1a2e; line-height: 1.2; }
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="card stat-pill mb-3" style="border-left-color:#28a745!important;">
                                    <div class="card-body py-3">
                                        <div class="label">Barangay's with Businesses</div>
